...
AS $$
DECLARE
  project_url TEXT := 'https://evhpswfiijjzpgghvorf.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImV2aHBzd2ZpaWpqenBnZ2h2b3JmIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyMzM1MDk2MywiZXhwIjoyMDM4OTI2OTYzfQ.af1j1wr9KjFrYxPPevk7zmhoUlm_pBiWoPK6dfc8T14'; -- full access needed for http request to storage
